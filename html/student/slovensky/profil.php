    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item"><a class="nav-link" href="/html/student/english/profil.php">Anglická verzia</a>
                </li>
        ...
        <div class="col-md-6">
            <div class="card mb-3">
                ...
                <div class="card-body text-center">
                    ...
                    <p class="card-text">Meno: <?php echo htmlspecialchars($_SESSION['first_name']); ?></p>
                    <p class="card-text">Priezvisko: <?php echo htmlspecialchars($_SESSION['last_name']); ?></p>
                    <p class="card-text">Email: <?php echo htmlspecialchars($_SESSION['email']); ?></p>
                    <p class="card-text">Telefón: <?php echo htmlspecialchars($_SESSION['telephone']); ?></p>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="card mb-3">
                ...
                <div class="card-body">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" id="deleteForm" method="post">
                        <input type="hidden" name="csrf_token" value="<?php echo generateCSRFToken(); ?>">
                        <button type="submit" name="delete_account" class="btn btn-danger">Odstrániť účet</button>
