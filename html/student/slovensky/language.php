        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item"><a class="nav-link"
                                        href="/html/student/english/language.php?name=<?php echo htmlspecialchars($learn); ?>">Anglická
                        verzia</a></li>
    ...
    <div class="row">
        ...
        if (!empty($lessons)) {
            foreach ($lessons as $lesson) {
                ...
                echo "<h5 class='card-title'>" . htmlspecialchars($lesson['slovak_name']) . "</h5>";
                echo "<p class='card-text'>ID lekcie: " . htmlspecialchars($lesson['id']) . "</p>";
                echo "<a href='lesson.php?id=" . htmlspecialchars($lesson['id']) . "' class='btn btn-primary'>Zobraziť lekciu</a>";
                echo "</div>";
                echo "</div>";
                echo "</div>";
            }
            ...
            echo "<div class='col'>";
            echo "<p>V adrese URL nie je uvedený parameter 'name' alebo neboli nájdené žiadne lekcie.</p>";
            echo "</div>";
        }
        ?>
    </div>
