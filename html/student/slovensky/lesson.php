        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item"><a class="nav-link"
                                        href="/html/student/english/lesson.php?id=<?php echo htmlspecialchars($lessonId); ?>">Anglická
                        verzia</a>
                </li>
        ...
        <div class="card">
            <div class="card-body text-center">
                ...
                <button class="btn btn-primary mt-3" style="margin-top: 30px !important;"
                        ...
                        onclick="startTestSlovak(<?php echo $lessonId; ?>, '<?php echo htmlspecialchars($lessonDetails['slovak_test_database']); ?>',
                                '<?php echo htmlspecialchars($lessonDetails['test']); ?>', <?php echo json_encode($canStartTest); ?>,
                        <?php echo json_encode($waitTime); ?>)">
                    <?php echo htmlspecialchars($lessonDetails['slovak_name']); ?>
                </button>
            </div>
        </div>
    <?php endif; ?>
