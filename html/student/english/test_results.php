...
if (isset($_POST['action']) && $_POST['action'] == 'clear_and_redirect') {
    ...
    header('Location: /html/student/english/lesson.php?id=' . urlencode($lesson_id));
    exit;
}
...
<div class="container">
    ...
    <?php foreach ($questions as $question) : ?>
        ...
        ?>
        <div class='question'>
            <p><b>Question:</b> <?= htmlspecialchars($question["question"]) ?></p>
    ...
    <div class="row">
        <div class="col-6">
            <form action="" method="POST">
                ...
                <button type="submit" class="btn btn-primary btn-block">Return to Lesson</button>
            </form>
        </div>
        <div class="col-6">
            <button onclick="window.print();" class="btn btn-secondary btn-block">Print this page</button>
        </div>
    </div>
</div>
