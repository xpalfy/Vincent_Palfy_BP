    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item"><a class="nav-link" href="/html/student/slovensky/learn.php">Slovak version</a>
                </li>
    ...
    <div class="row">
        <?php if ($result->num_rows > 0) :
            while ($row = $result->fetch_assoc()) :
                ...
                $english_text = htmlspecialchars($row["english_text"]);
                ?>
                <div class="col-md-6 lang">
                    <div class="card" onclick="location.href='language.php?name=<?php echo $name; ?>'">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text"><?php echo $english_text; ?></p>
                        </div>
                    </div>
                </div>
            <?php endwhile;
