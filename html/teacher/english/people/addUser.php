...
#[NoReturn] function insertUserIntoDatabase($conn): void
{
    ...
    if ($result->num_rows > 0) {
        ...
        header("Location: " . '/html/teacher/english/people/addUser.php');
        exit;
    }
    $stmt->close();
    ...
    if ($stmt->error) {
        ...
        $stmt->close();
        $conn->close();
        header("Location: " . '/html/teacher/english/students.php');
    }
    exit;
}
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item"><a class="nav-link" href="/html/teacher/slovensky/people/addUser.php">Slovak
                        version</a>
...
<div class="container">
    <div class="register">
        ...
        <form action="" method="post">
            ...
            <a href="../students.php" class="btn btn-link">Back</a>
        </form>
    </div>
</div>
