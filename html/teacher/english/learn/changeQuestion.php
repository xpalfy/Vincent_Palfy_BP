...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['updateQuestion'])) {
        ...
        $_SESSION['toast'] = array("status" => "success", "message" => "Question updated successfully");
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item"><a class="nav-link"
                                        href="/html/teacher/slovensky/learn/changeQuestion.php?id=<?php echo $questionID; ?>&topic=<?php echo $selectedTopic; ?>&lecture=<?php echo $selectedLecture; ?>">Slovak
                        version</a>
...
<div class='container'>
    <div class='question-form'>
        ...
        <form action="" method="post" class='question-form'>
            ...
            <div class="row">
                <div class="col-md-6">
                    <button type="submit" name="updateQuestion" class="btn btn-success btn-block">Change the question
                    </button>
                </div>
                <div class="col-md-6">
