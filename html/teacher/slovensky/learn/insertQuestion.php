    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item"><a class="nav-link" href="/html/teacher/english/learn/insertQuestion.php">Anglická
                        verzia</a>
...
<div class='container'>
    <div class='question-form'>
        ...
        <form action="" method="post" class='question-form'>
            ...
            <div class="row">
                <div class="col-md-6">
                    <button type="submit" name="createQuestion" class="btn btn-success btn-block">Vytvoriť otázku
                    </button>
                </div>
                <div class="col-md-6">
