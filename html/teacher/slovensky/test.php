    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item"><a class="nav-link" href="/html/teacher/english/test.php">Anglická verzia</a></li>
    ...
    <div id="searchQuestions" style="display: none;">
        ...
        <div id="questionsTableSection" style="display: none;">
            ...
            <table id="questionsTable" class="table table-striped">
                <thead>
                <tr>
                    <th>Slovenské otázky</th>
                    <th>Anglické otázky</th>
                    <th>Akcie</th>
                </tr>
                </thead>
                            ...
                            <div class="col-md-12">
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" id="basic-addon1">Počet otázok:</span>
                                    </div>
                                    ...
                                    <div class="input-group-append">
                                        <button type="submit" class="btn btn-primary" name="updateNum"
                                                id="updateNumBtn">Aktualizovať číslo
                                        </button>
                                    </div>
                                </div>
                            </div>
            ...
            <a href="" class="btn btn-primary mt-3" id="addQuestionLink">Pridať novú otázku</a>
        </div>
    </div>
    ...
    document.addEventListener('DOMContentLoaded', function () {
            ...
            if (lecture) {
                fetch(`learn/getTopics.php?lecture=${lecture}`)
                    ...
                    .then(data => {
                        ...
                        data.forEach(topic => {
                            const option = new Option(topic.slovak_name, topic.test);
        ...
        function fetchQuestions(topic, lecture) {
            fetch(`learn/getQuestions.php?topic=${topic}&lecture=${lecture}`)
                    ...
                    Object.entries(data.english).forEach(([id, question]) => {
                        ...
                        questionsTable.row.add([
                            ...
                            `<div class='btn-group' role='group'>
                                <a href="${changeUrl}" class="btn btn-info btn-sm">Zmeniť</a>
                                <button type="button" class="btn btn-danger btn-sm deleteQuestionBtn" data-id="${id}" data-topic="${topic}" data-lecture="${lecture}">Odstrániť</button>
                             </div>`
                        ]);
                    });
                ...
                .catch(() => toastr.error('Failed to load questions.'));
        }
